...
EMSCRIPTEN_BINDINGS(Module)
{
  ...
  class_<Optimize<double>>("Optimize")
      ...
      .function("setLocalOptimizer", &Optimize<double>::set_local_optimizer)
      .function("setLowerBounds", &Optimize<double>::set_lower_bounds)
      .function("setUpperBounds", &Optimize<double>::set_upper_bounds)
      .function("setMinObjective", &Optimize<double>::set_min_objective)
      .function("setMaxObjective", &Optimize<double>::set_max_objective)
      .function("addInequalityConstraint", &Optimize<double>::add_inequality_constraint)
      .function("addInequalityMConstraint", &Optimize<double>::add_inequality_mconstraint)
      .function("addEqualityConstraint", &Optimize<double>::add_equality_constraint)
      .function("addEqualityMConstraint", &Optimize<double>::add_equality_mconstraint)
      .function("setMaxtime", &Optimize<double>::set_maxtime)
      .function("setMaxeval", &Optimize<double>::set_maxeval)
